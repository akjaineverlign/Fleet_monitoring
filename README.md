...
## Git hints & common issues

* If `git push` is rejected because the remote has commits, prefer pulling with rebase:
...
* To clean unreachable objects and improve performance (optional):
...
* If you accidentally need to overwrite remote (destructive):
...
Please follow conventional commits and include a short description of changes.

---

## License

This project does not include a license file by default. Add a `LICENSE` file (MIT recommended) if you want to make it open source.

---

## Contact

If you need help running or modifying the project, reply here or open an issue in the repository with details and error logs.

---

*Prepared for the "Drone Fleet Monitor" Next.js TypeScript project.*
