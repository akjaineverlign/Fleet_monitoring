...
export function Sidebar({ currentPage }: SidebarProps) {
  ...
  const getActiveItem = () => {
    ...
    if (pathname === "/case-management") return "Case Management"
    ...
    <div className="w-56 bg-slate-950 border-r border-slate-800 h-screen flex flex-col">
      ...
      <div className="p-4 border-t border-slate-800 text-xs text-gray-500 space-y-2">
        ...
        <button
          ...
          className="w-full flex items-center gap-2 px-3 py-2 mt-2 rounded-lg transition-colors text-sm font-medium text-red-400 hover:bg-red-500/10 hover:text-red-300 border border-red-500/30"
        >
